...
tasks.forEach((task, key) => {
        ...
        item.innerHTML =`
            ...
            <div class="flex justify-end gap-3">
                <img src="../Assets/edit.png" alt="icon delete" width="20px" onclick="edit_task(${tasks})" class="cursor-pointer hover:opacity-50 ">
...
function edit_task(task){
    ...
    child.innerHTML +=`
      <div class="   rounded-lg p-6 max-w-md mx-auto w-full border border-gray-200 p-10" >
                            ...
                            <div class="mb-4">
                                <h3 class="text-xl font-semibold text-gray-700">Title:${task.titer} <span class="font-normal">Project Planning</span></h3>
                            </div>
                            ...
                            <div class="mb-4">
                                <p class="text-gray-600"><strong>Priority:</strong> <span class="text-red-500 font-bold">${task.Priority}</span></p>
                            </div>
                    
                            <div class="mb-4">
                                <p class="text-gray-600"><strong>Status:</strong> <span class="text-yellow-500 font-bold">${task.status}</span></p>
                            </div>
                    
                            <div class="mb-4">
                                <p class="text-gray-600"><strong>Deadline:</strong> <span>${task.Date}</span></p>
                            </div>
                    
                            <div class="flex items-center mb-4">
                                <p class="text-gray-600"><strong>Color:</strong>${task.Color}</p>
                                <div class="w-6 h-6 ml-2 rounded-full" style="background-color: #FFD700;">${task.Color}</div>
                            </div>
                    
                            <div class="flex justify-end mt-6 gap-2">
                                <button class="bg-green-400 text-white px-8 py-2 rounded-md hover:bg-green-600" id="edit_task">Edit</button>
                            </div>
